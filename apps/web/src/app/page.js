...
const features = [
  ...
  },
  {
    ...
    description: "Personalize your website and tailor it to your needs.",
    icon: FingerPrintIcon,
  },
  {
    name: "Powerful API.",
    description: "Utilize cURL to access your data via various API endpoints.",
    icon: Cog6ToothIcon,
  },
  {
                ...
                <div className="mt-20">
                  ...
                  <div className="mt-6 sm:max-w-xl">
                    <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
                      Digital prayer times for growing mosques
                    </h1>
                    <p className="mt-6 text-xl text-gray-500">
                      Provide a seamless and accurate way to inform the
                      congregation about the timing of each prayer throughout
                      the day.
                    </p>
                  </div>
                  <form
          ...
          <div className="mt-32">
            <div className="mx-auto max-w-md px-6 sm:max-w-3xl lg:max-w-7xl lg:px-8">
              <div className="lg:grid lg:grid-cols-2 lg:items-center lg:gap-24">
                <div>
                  <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                    Explore a suite of applications
                  </h2>
      ...
      <main>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Launch your website swiftly using our intuitive website builder.
                Get online in a matter of moments!
              </p>
            </div>
          </div>
        ...
        <div className="relative isolate mt-32 bg-white px-6 sm:mt-56 lg:px-8">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600">
            Be a part of our initiative to forever create free software for
            institutions and join us in this ongoing commitment.
          </p>
        ...
        <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
          ...
          <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
            <p className="text-xs leading-5 text-gray-500">
              &copy; 2023 MosqueICU, Limited. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
